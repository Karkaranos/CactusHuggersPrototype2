...
public class Interactables
{
    ...
    [Tooltip("What platforms should stop moving when the related button is pressed")]
    [SerializeField] private ChangedObject[] _platformsToChange;
    ...
    public ChangedObject[] ResetsThese { get => _platformsToChange; set => _platformsToChange = value; }
}
